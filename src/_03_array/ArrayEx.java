...
// - 배열의 원소는 모두 같은 타입
// - 처음 선어한 배열 크기 변경 불가능 (단, ArrayList 컬렉션의 경우, 동적으로 크기 조절 가능)
...
//        System.out.println(temp[0]); // NullPointerException
        ...
        System.out.println("intArray : " + intArray); // 저장된 참조 값이 나옴(참조값 저장)
        intArray[1] = 77;
        System.out.println("intArray[1] : " + intArray[1]);
...
//        System.out.println("doubleArray length : " + doubleArray[doubleArray.length]); // ArrayIndexOutOfBoundsException
        ...
        // 3차원 배열의 값 출력
        System.out.println("length > "+threeDimensionArr.length);
        ...
        // ver 2. arraycopy() 사용
        // System.arraycopy(Object src, int srcPost, Object dest, int destPost, int lenght);
        // - Object src: 원본 배열
        ...
        System.out.println("origin Array : " + Arrays.toString(originArray)); // [1, 2, 3, 4, 5]
        ...
        System.out.println("copied Array : " + Arrays.toString(rangeArray)); // [2, 3, 4]
